...
// Sostituisce i partecipanti di una gara con quelli indicati.
...
export async function competitionRuns(c, userId = null) {
  ...
  const rows = await sql`
    select a.id, a.user_id, c.athlete_name, c.avatar_url, u.sex, u.birth_date,
...
export async function participants(c) {
  return sql`select c.user_id, c.athlete_name, c.avatar_url, u.sex, u.birth_date
