...
async function seed(db) {
  ...
  for (const c of comps) {
    await db.query(`insert into competitions (name, distance_m, start_date, end_date, best_segment, created_by)
                    values ($1, $2, $3, $4, $5, 1)`, [c[0], Math.round(c[1] * 1000), c[2], c[3], c[4] ?? false]);
  }
