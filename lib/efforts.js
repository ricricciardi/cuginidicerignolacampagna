...
// Parziali da salvare, dal dettaglio Strava: distanza, tempo trascorso e in movimento.
export const splitsFromDetail = (detail) =>
  (detail?.splits_metric ?? []).map((x) => ({ m: x.distance, s: x.elapsed_time, mv: x.moving_time }));
