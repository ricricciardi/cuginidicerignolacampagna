...
export default async function Login({ searchParams }) {
  ...
  return (
    <main>
      ...
      {/* Chi arriva la prima volta deve trovare subito la registrazione: pulsante, non link, e
          sopra il modulo, così resta visibile anche quando il telefono apre la tastiera. */}
